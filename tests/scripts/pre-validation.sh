...
(
  ...
  watson_assistant_instance_crn_var_name="watson_assistant_instance_crn"
  ...
  secrets_manager_instance_crn_var_name="secrets_manager_instance_crn"
  ...
  watson_assistant_instance_crn_value=$(terraform output -state=terraform.tfstate -raw watson_assistant_instance_crn)
  ...
  jq -r --arg prefix_var_name "${prefix_var_name}" \
        ...
        --arg watson_assistant_instance_crn_var_name "${watson_assistant_instance_crn_var_name}" \
        --arg watson_assistant_instance_crn_value "${watson_assistant_instance_crn_value}" \
        ...
        --arg secrets_manager_instance_crn_var_name "${secrets_manager_instance_crn_var_name}" \
        --arg secrets_manager_instance_crn_value "${secrets_manager_instance_crn_value}" \
        ...
        '. + {($prefix_var_name): $prefix_value,
          ...
          ($watson_assistant_instance_crn_var_name): $watson_assistant_instance_crn_value,
          ...
          ($secrets_manager_instance_crn_var_name): $secrets_manager_instance_crn_value,
